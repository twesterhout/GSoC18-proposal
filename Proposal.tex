...
\title{Google Summer of Code Proposal: Boost.Static_views}
\date{March 2018}
...
\begin{abstract}
    ...
    \texttt{Static_views} library. The library focuses on working with
...
\section*{Background Information}
    ...
    working on the very same project I am proposing here. I believe Static_views
    ...
    (which Static_views currently uses). I also have experience in using
    \texttt{Doxygen} and have played around with \texttt{Standardese}.

\newpage
\section*{Project Proposal}
    \paragraph{Ranges TS, Boost.Hana and Static_views} Computations in
    ...
    (Ranges TS) and type-level computations (Boost.Hana). Static_views is meant
...
\end{spacing}
    ...
    Static_views library to ``review-ready'' state, i.e. a state in which Boost
    ...
    \begin{itemize}
        \item Fix \texttt{GCC} so that it can compile Static_views.
...
\section*{Schedule}
    ...
    \begin{tabular}{|r c l|p{10cm}|}
        ...
        18th June   & --- & 22nd June   & \multirow{4}{10cm}{%
            ...
            library to make it work correctly with Static_views.
        } \\
        25th June   & --- & 29th June   & \\
        2nd  July   & --- & 6th  July   & \\
                    &     &             & \\
